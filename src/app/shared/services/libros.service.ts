...
export class LibrosService {
  ...
  private libros: Libro[] = [
    { id:1, titulo:'El nombre del viento', autor:'Patrick Rothfuss', precio:18.99,
      portada:'https://books.google.com/books/content?id=o0R9DQAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl', genero:'Fantasía',
      valoracion:5, descripcion:'La historia de Kvothe, un mago legendario narrada por él mismo.' },
    { id:2, titulo:'Cien años de soledad', autor:'Gabriel García Márquez', precio:15.99,
      portada:'https://books.google.com/books/content?id=vOGEDQAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl', genero:'Realismo Mágico',
      valoracion:5, descripcion:'La saga de la familia Buendía en el mítico pueblo de Macondo.' },
    { id:3, titulo:'1984', autor:'George Orwell', precio:14.00,
      portada:'https://books.google.com/books/content?id=kotPYEqx7kMC&printsec=frontcover&img=1&zoom=1&edge=curl', genero:'Distopía',
    ...
    { id:4, titulo:'Dune', autor:'Frank Herbert', precio:22.00,
      portada:'https://books.google.com/books/content?id=B5PkCwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl', genero:'Ciencia Ficción',
    ...
    { id:5, titulo:'El Hobbit', autor:'J.R.R. Tolkien', precio:16.75,
      portada:'https://books.google.com/books/content?id=pD6arNyKyi8C&printsec=frontcover&img=1&zoom=1&edge=curl', genero:'Fantasía',
      valoracion:4, descripcion:'La aventura de Bilbo Bolsón en tierras de dragones y enanos.' },
    { id:6, titulo:'Don Quijote de la Mancha', autor:'Miguel de Cervantes', precio:18.99,
      portada:'https://books.google.com/books/content?id=M4IZEAAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl', genero:'Clásico',
    ...
    { id:7, titulo:'Harry Potter y la piedra filosofal', autor:'J.K. Rowling', precio:19.99,
      portada:'https://books.google.com/books/content?id=wrOQLV6xB-wC&printsec=frontcover&img=1&zoom=1&edge=curl', genero:'Fantasía',
      valoracion:5, descripcion:'El inicio de la saga del joven mago en el colegio Hogwarts.' },
    { id:8, titulo:'El principito', autor:'Antoine de Saint-Exupéry', precio:12.50,
      portada:'https://books.google.com/books/content?id=OgRBDQAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl', genero:'Clásico',
